import Easy from "./EasyMode/Easymode"; // Import the 'Easy' component from the 'EasyMode' directory
import Medium from "./MediumMode/Mediummode"; // Import the 'Medium' component from the 'MediumMode' directory
import Hard from "./HardMode/Hardmode"; // Import the 'Hard' component from the 'HardMode' directory
import Home from "./HomeMode/Home"; // Import the 'Home' component from the 'HomeMode' directory
